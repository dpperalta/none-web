...
},  
{
  ...
  {
    name: "/", label: "Admisiones", Icon: PresenciaIcon,
    items: [
      { name: "/form/course-enroll", label: "Matricular alumnos", Icon: RegistrarIcon, onClick },
      { name: "/form/course-enroll-exchange", label: "Gestionar intercambios", Icon: RegistrarIcon, onClick },
      { name: "/form/course-enroll-beca", label: "Gestionar becas", Icon: RegistrarIcon, onClick }
    ]
},
    ...
    },
    {
        ...
        Icon: PagosIcon,
        items: [
          { name: "/payment/pay", label: "Cobrar pensiones", Icon: PagarIcon, onClick },
          { name: "/payment/bill", label: "Emitir Facturas", Icon: FacturaIcon, onClick },
          { name: "/report/payment", label: "Cartera de pagos", Icon: ReporteIcon, onClick }
