...
import React from "react";
  ...
  export const TableGroups = () => {
      ...
      return (
            <MaterialTable        
                title="Tabla con acciones grupales"
                tableRef={tableRef}
                /* 
                ...
                */
                ...
                options={{
                    selection: true, //Se se habilita, permite acciones grupales (sobre los seleccionados)
                    sorting: true,
                    filtering:true,
                    search: true,
                    grouping: true,
                ...
                actions={[
                    ...
                    //Acciones para el grupo seleccionado
                    {
                        tooltip: 'Borrar las filas seleccionadas',
                        icon: 'delete',
                        onClick: (evt, data) => alert('¿Realmente quieres borrar? ' + data.length + ' filas')
                    }        
                ]}
                localization={{
                    pagination: {
